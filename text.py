...
status_messages_with_names = {
    1: 'Груз от отправителя {sender}, мест={place}, вес={weight}кг на получателя {recipient} прошёл оформление авиа перевозки{to}.',
    2: 'Груз от отправителя {sender}, мест={place}, вес={weight}кг на получателя {recipient} готов к загрузке в ВС для авиа перевозки в {to}.',
    3: 'Груз от отправителя {sender}, мест={place}, вес={weight}кг на получателя {recipient} вылетел в {to}.'
}
